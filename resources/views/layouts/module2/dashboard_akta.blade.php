@extends('antriannew.module.layout_akta')
                  ...
                  <div class="card border-0 shadow-sm bg-white"  >
                    <div class="card-body p-4 ">
                      <div class="d-flex justify-content-start">
                        ...
                        <div>
                          <p id="jumlah-antrian-akta" class="fs-3 text-warning mb-1"></p>
                  ...
                  <div class="card border-0 shadow-sm bg-white">
                    <div class="card-body p-4">
                      <div class="d-flex justify-content-start">
                        ...
                        <div>
                          <p id="antrian-sekarang-akta" class="fs-3 text-success mb-1"></p>
                  ...
                  <div class="card border-0 shadow-sm bg-white">
                    <div class="card-body p-4">
                      <div class="d-flex justify-content-start">
                        ...
                        <div>
                          <p id="antrian-selanjutnya-akta" class="fs-3 text-info mb-1"></p>
                  ...
                  <div class="card border-0 shadow-sm bg-white">
                    <div class="card-body p-4">
                      <div class="d-flex justify-content-start">
                        ...
                        <div>
                          <p id="sisa-antrian-akta" class="fs-3 text-danger mb-1"></p>
              ...
              <div class="card border-0 shadow-sm bg-white">
                <div class="card-body p-4">
                  <div class="table-responsive">
                    <table class="table table-bordereda table-hover tabel-antrian-akta" width="100%">
                      <thead>
                        <tr>
                          <th>Nomor Antrian Akta</th>
                          <th>Panggil</th>
                        </tr>
                      </thead>
                    </table>
